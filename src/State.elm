...
updateUnderlying msg model =
    case msg of
        ...
        RequestUnscopedToken openstackLoginUnscoped ->
            ( model, Rest.Keystone.requestUnscopedAuthToken model.openstackApiProxyUrl openstackLoginUnscoped )
        ...
        RequestNewProjectToken openstackCreds ->
            ...
            in
            ( model, Rest.Keystone.requestScopedAuthToken model.openstackApiProxyUrl <| OSTypes.PasswordCreds newOpenstackCreds )
        ...
        JetstreamLogin jetstreamCreds ->
            let
                ...
                cmds =
                    List.map
                        (\creds -> Rest.Keystone.requestUnscopedAuthToken model.openstackApiProxyUrl creds)
                        openstackCredsList
            in
    ...
    case msg of
        ...
        PrepareCredentialedRequest requestProto posixTime ->
            let
                -- Add proxy URL
                requestNeedingToken =
                    requestProto model.openstackApiProxyUrl
...
createUnscopedProvider model password authToken authUrl =
    ...
    , Rest.Keystone.requestUnscopedProjects newProvider model.openstackApiProxyUrl
    )
...
requestAuthToken model project =
    ...
    in
    Rest.Keystone.requestScopedAuthToken model.openstackApiProxyUrl creds
